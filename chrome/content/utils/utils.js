...
var gmanager_Utils = new function()
{
  ...
  this.loadSimpleURI = function(aUrl)
  {
    ...
    this.loadURI(aUrl,
                 gmanager_Utils.WEBSITE + manager.version + "/",
                 null,
                 "background");
  }
  ...
  this.loadURI = function(aUrl, aReferrerUrl, aData, aLocation)
  {
    ...
    switch (aLocation)
    {
      ...
      case "existing":
      {
        ...
        if (thebrowser)
          thebrowser.webNavigation.loadURI(aUrl,
      ...
      case "current":
        tabbrowser.webNavigation.loadURI(aUrl,
                                         Components.interfaces.nsIWebNavigation.LOAD_FLAGS_NONE,
                                         referrerUri,
                                         mimeInputStream,
                                         null);
      ...
      case "background":
        ...
        newTab.webNavigation.loadURI(aUrl,
                                     Components.interfaces.nsIWebNavigation.LOAD_FLAGS_NONE,
                                     referrerUri,
                                     mimeInputStream,
                                     null);
  ...
  this.loadDefaultMail = function(aHref)
  {
    ...
    if (externalProtocolService)
    {
      ...
      var uri = ioService.newURI((aHref && aHref.startsWith("mailto:") ? aHref : "mailto:"),
                                 null,
                                 null);
