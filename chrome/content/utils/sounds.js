...
var gmanager_Sounds = new function()
{
  ...
  this.init = function()
  {
    ...
    this._soundService = Components.classes["@mozilla.org/sound;1"]
  ...
  this.selectFile = function()
  {
    ...
    filePicker.init(window,
                    this.getString("select-file"),
                    Components.interfaces.nsIFilePicker.modeOpen);
    filePicker.appendFilter(this.getFString("sound-files",
                                            [this.WAV_FILTER_TYPE]),
                            this.WAV_FILTER_TYPE);
    filePicker.show();
